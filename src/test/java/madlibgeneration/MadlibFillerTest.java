...
public class MadlibFillerTest {
    ...
    @BeforeEach
    void initializeTempFiles() throws IOException, TextNotProcessedException {
        ...
        Madlib testMadlib1 = new Madlib(textForFile, testTextFile.toString(), 1);
    }
    ...
    void testFillInMadlib() throws TextNotProcessedException, IOException {
        ...
        testMadlib.fillInMadlib(replacementWords, outputFile2.toString());
